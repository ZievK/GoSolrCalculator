...
let infl: number = 0.05;
let sml_mnth_23: number = 1399;
let sml_mnth_24: number = sml_mnth_23*(1+infl);
let med_mnth_23: number = 1740;
let med_mnth_24: number = med_mnth_23*(1+infl);
let lrg_mnth_23: number = 2900;
let lrg_mnth_24: number = lrg_mnth_23*(1+infl);
let xlrg_mnth_23: number = 4400;
let xlrg_mnth_24: number = xlrg_mnth_23*(1+infl);
//create array of costs for each year
let mnth_23: number[] = [sml_mnth_23, med_mnth_23, lrg_mnth_23, xlrg_mnth_23];
let mnth_24: number[] = [sml_mnth_24, med_mnth_24, lrg_mnth_24, xlrg_mnth_24];

//initialise variables, allowing for tariff increase to be changed in future
let trfinc: number = 0.13;
let lw_trf_23: number = 3.508;
let lw_trf_24: number = lw_trf_23*(1+trfinc);
let hi_trf_23: number = 4.2656;
let hi_trf_24: number = hi_trf_23*(1+trfinc);
